...
const { getProvider, getProgram } = require('./anchorHelpers'); 

const server = http.createServer(app);

const idl = require('../escrow/trading_escrow/target/idl/escrow.json'); // generated using `anchor idl fetch <programId>`
const programId = new PublicKey("gv4Ep7vbpPgHfTkZbgb834Jyve2mH19iSqCsQy6oukn");
